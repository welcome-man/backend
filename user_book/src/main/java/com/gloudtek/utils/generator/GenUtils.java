package com.gloudtek.utils.generator;
...
import com.gloudtek.utils.DateUtils;
...
public class GenUtils {
	...
	public static List<String> getTemplates(){
		...
		templates.add("template/listvue.vm");
		return templates;
	}
	...
	public static String getFileName(String template, String className, String packageName){
		...
		if(template.contains("listvue.vm")){
			return "js" + File.separator + className.toLowerCase() + ".vue";
		}
