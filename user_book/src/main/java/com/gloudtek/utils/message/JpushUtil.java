...
/**
 * @see https://github.com/jpush/jpush-api-java-client/blob/master/example/main/java/cn/jpush/api/examples/PushExample.java#L1 
 */
public class JpushUtil {
 
    private final static String appKey = "9f9ed9b243ab753d4d086d53";
 
    private final static String masterSecret = "a17ea57cf1b7826875a71785";
    ...
    public static int sendToAll( String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload= JpushUtil.buildPushObject_android_and_ios(notification_title,msg_title,msg_content,extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult=jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if(pushResult.getResponseCode()==200){
...
//        if(JpushUtil.sendToAllAndroid("testAndroid","testAndroid","this is a Android Dev test","")==1){
